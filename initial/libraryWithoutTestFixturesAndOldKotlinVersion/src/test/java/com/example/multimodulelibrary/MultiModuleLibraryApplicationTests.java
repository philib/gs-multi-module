...
class MultiModuleLibraryApplicationTests {
    ...
    void ensure_someFile_is_found_once() {
        try {
            ...
            assertThat(resources[0].getURL().toString()).containsPattern(Pattern.compile("file:.*/gs-multi-module/initial/libraryWithoutTestFixturesAndOldKotlinVersion/build/resources/main/someFile"));
        } catch (IOException e) {
            assert false;
        }
    }
